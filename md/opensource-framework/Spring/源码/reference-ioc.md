...
1. 初始化 BeanFactoryPostProcessor。 
2. 执行 BeanFactoryPostProcessor 的 postProcessBeanFactory。 
3. 初始化 BeanPostProcessor。
   发生getBean操作实现依赖注入: 

4. 执行 InstantiationAwareBeanPostProcessor 的 postProcessBeforeInstantiation 
5. 执行 bean 的构造函数 (有参 和 无参)
   * Initialization（初始化）
6. 执行 postProcessBeforeInstantiation 的 postProcessPropertyValues 
7. 为 bean 注入属性 populateBean
8. 执行 bean 实现的有关 Aware 接口 
9. 执行 BeanPostProcessor.postProcessBeforeInitialization 
10. 接下来根据具体情况： 
    PostConstrut–> InitializingBean –> xml中配置init方法 
11. BeanPostProcessor.postProcessAfterInitialization （AOP 代理的关键）
12. 容器执行 
13. DisposableBean.destroy

# 【Spring源码】Spring IOC 容器源码分析（一）

[Spring IOC 容器](https://mp.weixin.qq.com/s/IJKQH8sM_yjts3gIvAEjUQ)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE2kefum7Lq2phKfdhp20P916jicTic4YiaSzhLNIBwqYHxhic0yHw6SuTx1kkDdP38vmRthwic1aBfaqeg/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE2kefum7Lq2phKfdhp20P91riaOlBQxcia9vLJ1ibqDcSicTASR11kbQn7HG2GQj9sv8M2VThoPZ834og/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
...
![img](https://mmbiz.qpic.cn/mmbiz_png/YUYc62VIvE2kefum7Lq2phKfdhp20P91EKzib64qvogiaIhr9W0uSxnrT7QWIpPAtM0pJzArzLUJpRF67oIRHPGA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)
